...
#define HI_VO_INTF_HDMI1      (0x01L << 12)
...
typedef enum {
    HI_VO_FIXED_CLK_148_5M  = 0, /* Fixed clock source 148.5MHz */
    HI_VO_FIXED_CLK_134_4M  = 1, /* Fixed clock source 134.4MHz */
    HI_VO_FIXED_CLK_108M    = 2, /* Fixed clock source 108MHz */
    HI_VO_FIXED_CLK_74_25M  = 3, /* Fixed clock source 74.25MHz */
    HI_VO_FIXED_CLK_64M     = 4, /* Fixed clock source 64MHz */
    HI_VO_FIXED_CLK_54M     = 5, /* Fixed clock source 54MHz */
    HI_VO_FIXED_CLK_37_125M = 6, /* Fixed clock source 37.125MHz */
    HI_VO_FIXED_CLK_13_5M   = 7, /* Fixed clock source 13.5MHz */
...
typedef struct {
    ...
    hi_u32 pll_mode;  /* RW, range: [0, 0x1]; integer, decimal mode */
} hi_vo_pll;
...
typedef struct {
    ...
    hi_u32 chn_busy_num; /* R; busy channel buffer number */
} hi_vo_chn_status;
...
typedef struct {
    hi_bool         is_slave;                        /* RW; TD_TRUE: slave mode, TD_FALSE: master mode */
